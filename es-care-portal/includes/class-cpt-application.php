...
class ESC_Portal_CPT_Application {
	...
	public static function get_snapshot( $application_id ) {
		...
		return array(
			...
			'ssn'                     => (string) get_post_meta( $application_id, '_esc_ssn', true ),
			'drivers_license'         => (string) get_post_meta( $application_id, '_esc_drivers_license', true ),
	...
	public static function save_snapshot( $application_id, $data ) {
		$fields = array(
			...
			'_esc_ssn'                    => isset( $data['ssn'] ) ? sanitize_text_field( $data['ssn'] ) : '',
			'_esc_drivers_license'        => isset( $data['drivers_license'] ) ? sanitize_text_field( $data['drivers_license'] ) : '',

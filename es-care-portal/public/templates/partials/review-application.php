...
<section class="esc-card">
	...
	<?php if ( $snap['resume_file'] ) : ?>
		<p><a class="esc-button esc-button--ghost" href="<?php echo esc_url( ESC_Portal_Uploads::download_url( $id ) ); ?>"><?php esc_html_e( 'Download resume', 'es-care-portal' ); ?></a></p>
	<?php endif; ?>

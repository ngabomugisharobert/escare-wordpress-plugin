...
<section class="esc-dash-panel">
	...
	<p class="esc-dash-copy"><?php esc_html_e( 'Complete the pre-hire assessment after you submit your application. You can retake a test if you need a better score.', 'es-care-portal' ); ?></p>

	<?php if ( empty( $assessments ) ) : ?>
		<p><?php esc_html_e( 'No assessments are available yet.', 'es-care-portal' ); ?></p>
	<?php else : ?>
		<div class="esc-tiles">

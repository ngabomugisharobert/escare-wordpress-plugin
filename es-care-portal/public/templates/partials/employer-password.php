...
<section class="esc-dash-panel esc-dash-panel--centered">
	...
	<section class="esc-card esc-card--narrow" id="esc-delete-account">
		...
		<?php else : ?>
			<p><?php esc_html_e( 'This sends a deletion request to ES Care staff. They will review it and remove the account. Job listings you posted remain until staff remove them.', 'es-care-portal' ); ?></p>

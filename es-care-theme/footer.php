...
<footer class="escare-footer" role="contentinfo">
	<div class="escare-wrap escare-footer-grid">
		<div class="escare-footer-brand">
			<img class="escare-footer-logo" src="<?php echo esc_url( escare_logo_url() ); ?>" alt="<?php echo esc_attr__( 'ES Care Services', 'es-care' ); ?>" width="240" height="90" loading="lazy" decoding="async">
			<p class="escare-footer-legal"><?php esc_html_e( 'E&S Care Services LLC', 'es-care' ); ?></p>
	...
	<div class="escare-footer-bar">
		<div class="escare-wrap">
			<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php esc_html_e( 'E&S Care Services LLC. All rights reserved.', 'es-care' ); ?></p>
		</div>
	</div>
</footer>
<?php wp_footer(); ?>
